...
export default function ComingSoon({ onBack }: { onBack: () => void }) {
  return (
    <section className="relative min-h-screen bg-charcoal text-ivory-white px-6 py-24 md:px-12 lg:px-20">
      <div className="mx-auto flex min-h-[calc(100vh-6rem)] max-w-5xl flex-col items-center justify-center gap-10 text-center">
        <motion.div
          ...
          className="space-y-6"
        >
          <p className="text-sm uppercase tracking-[0.4em] text-ivory-white/40">Coming Soon</p>
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-semibold tracking-[-0.03em] text-ivory-white">
            This page is under construction.
          </h1>
          <p className="mx-auto max-w-3xl text-sm md:text-base leading-relaxed text-ivory-white/70">
