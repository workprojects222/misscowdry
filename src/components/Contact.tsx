...
export default function Contact() {
  ...
  return (
    <section id="contact" ref={containerRef} className="relative overflow-hidden bg-charcoal py-24 md:py-32 lg:py-40">
      <div className="container-wide px-6 md:px-12 lg:px-20">
        <div className="max-w-5xl mx-auto">
          <div className="mb-12 md:mb-16">
            ...
            >
              <div>
                <h2 className="text-5xl md:text-6xl lg:text-7xl font-light tracking-[-0.02em] text-ivory-white">
                  Let's Build
                </h2>
              ...
              <p className="text-ivory-white/60 text-base md:text-lg leading-relaxed max-w-xl">
          ...
          <div className="grid lg:grid-cols-[0.95fr_1.05fr] gap-12 lg:gap-16">
            <motion.div
              ...
              className="rounded-[32px] border border-ivory-white/10 bg-ivory-white/5 p-8"
            >
              <div className="space-y-8 mb-10">
                {[
                  ...
                  <div key={item.label} className="border-t border-ivory-white/10 pt-4">
                    <p className="text-ivory-white/50 text-xs tracking-[0.15em] uppercase mb-2">{item.label}</p>
                    <p className="text-ivory-white text-base">{item.value}</p>
                  </div>
                ))}
              </div>
              ...
              <div className="flex flex-wrap gap-4">
                {['Instagram', 'Facebook', 'Twitter'].map((social) => (
                  <button
                    key={social}
                    className="px-5 py-3 text-xs tracking-[0.1em] uppercase text-ivory-white/60 hover:text-ivory-white border border-ivory-white/20 hover:border-ivory-white/40 transition-colors"
                  >
                    {social}
                  </button>
                ))}
            ...
            >
              ...
              <button
                type="submit"
                className="w-full md:w-auto px-10 py-5 bg-luxury-gold text-rich-black text-sm tracking-[0.1em] uppercase hover:bg-champagne-gold transition-colors"
              >
                Send Message
              </button>
            </motion.form>
